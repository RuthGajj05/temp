    ...
    def center_target_with_vision(self, target_object: str, max_attempts: int = 5, tolerance: float = 0.1) -> str:
        ...
        try:
            ...
            for attempt in range(max_attempts):
                ...
                # Send to assistant for HORIZ_OFFSET analysis
                offset, confidence = self.get_horizontal_offset(image_path, target_object)
                ...
                print(f"📊 HORIZ_OFFSET: {offset}, CONFIDENCE: {confidence}")
...
- Values closer to 0.0 mean more centered"""
            ...
            # Parse HORIZ_OFFSET and CONFIDENCE
            import re
            ...
            if offset_match and confidence_match:
                ...
                print(f"⚠️ Could not parse HORIZ_OFFSET or CONFIDENCE from: {analysis}")
                return None, None
