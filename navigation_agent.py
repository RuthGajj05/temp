...
class NavigationAgent:
    ...
    def _analyze_panorama_images(self, image_paths: list, target_object: str, estimate_distance: bool) -> str:
        """Analyze 5 panorama images using simple debug approach with retries."""
        max_retries = 3
...
UP: [target visible? position?]"""
                ...
                if any(key in analysis for key in ["RANKING:", "BEST_VIEW:", "TARGET:", "POSITION:", "DISTANCE:", "CONFIDENCE:"]):
                    ...
                    if attempt < max_retries - 1:
                        ...
                        return f"TARGET: not visible\nBEST_VIEW: unknown\nCONFIDENCE: 1\nDETAILS: Vision analysis failed after {max_retries} attempts"
