...
class NavigationAgent:
    ...
    def _analyze_panorama_images(self, image_paths: list, target_object: str, estimate_distance: bool) -> str:
        """Analyze 5 panorama images in a single vision call with strict output format."""
        try:
...
UP: [target visible? position?]"""
            ...
            # Send all images in one vision call
            ...
            print(f"Panorama Analysis: {analysis}")
            return analysis
...
DETAILS: [additional observations]"""
    ...
    def _determine_movement_strategy(self, vision_analysis: str, current_distance: float, target_distance: float) -> str:
        ...
        try:
            ...
            # Vision already determined direction, now use sonar for step size
    ...
    def navigate_to_distance(self, target_distance: float, target_object: str = "object") -> str:
        ...
        try:
            ...
            # Turn toward the best view
            if target_direction == "left":
                print("🔄 Turning toward left view...")
                turn_result = turn_in_place_left(30, 25, 1.0)
                print(f"Turn result: {turn_result}")
            elif target_direction == "right":
                print("🔄 Turning toward right view...")
                turn_result = turn_in_place_right(30, 25, 1.0)
                print(f"Turn result: {turn_result}")
            else:  # center, down, up
                print("🔄 Target is ahead, proceeding forward...")
